...
"""
    ...
    def run(self):
        ...
        # Download all translations for selected languages automatically
        for language_code in selected_languages:
            if language_code not in translations_by_language:
                print(f"Language '{language_code}' not found. Skipping.")
                continue

            print(f"\nDownloading all translations for language: {language_code}")
            print(f"Total translations to download: {len(translations_by_language[language_code])}")

            # Download all translations for this language
            for translation in translations_by_language[language_code]:
